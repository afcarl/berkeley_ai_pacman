...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getValue(self, gameState, agentIndex, depth):
        ...
        # ghost
            ...
            return self.getMinValueOverSuccessors(gameState, agentIndex, depth)

    """
    Get maximum value over successors to gameState when those successors are
    under the control of agentIndex at depth

    Return the action to get to that max state and the max value as a tuple
    """
    ...
    """
    Get minimum value over successors to gameState when those successors are
    under the control of agentIndex at depth

    Return the action to get to that min state and the min value as a tuple
    """
